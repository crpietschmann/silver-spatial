...
{
    public class GeoMultiLineString : GeometryCollection<GeoLineString>
    {
        ...
        public GeoMultiLineString(IList<GeoLineString> geometries)
            : base(geometries)
        {
        }
        ...
        {
            get { return SilverSpatial.GeometryType.MultiLineString; }
        }
