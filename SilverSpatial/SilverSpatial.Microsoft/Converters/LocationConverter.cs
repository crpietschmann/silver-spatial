...
{
    public class LocationConverter : SilverSpatial.Converters.ValueConverterBase<GeoPoint, Location>
    {
        private GeoPointConverter converter = new GeoPointConverter();

        public override Location Convert(GeoPoint obj)
        {
            return converter.ConvertBack(obj);
        }

        public override GeoPoint ConvertBack(Location obj)
        {
